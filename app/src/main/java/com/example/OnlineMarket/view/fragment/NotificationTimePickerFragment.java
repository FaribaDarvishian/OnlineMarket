...
import com.example.OnlineMarket.databinding.FragmentNotificationTimePickerBinding;
import com.example.OnlineMarket.viewmodel.NotificationTimePickerViewModel;
...
public class NotificationTimePickerFragment extends DialogFragment {
    ...
    public static com.hfad.onlinemarket.view.fragment.NotificationTimePickerFragment newInstance() {
        com.hfad.onlinemarket.view.fragment.NotificationTimePickerFragment fragment = new com.hfad.onlinemarket.view.fragment.NotificationTimePickerFragment();
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        return new AlertDialog.Builder(getActivity())
                ...
                .setPositiveButton(android.R.string.ok, (dialog, which) -> {
                    ...
                    mViewModel.setResult(com.hfad.onlinemarket.view.fragment.NotificationTimePickerFragment.this, milliSecondsLeft);
                })
