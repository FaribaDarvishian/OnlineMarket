...
import com.example.OnlineMarket.databinding.FragmentProductListBinding;
import com.example.OnlineMarket.viewmodel.ProductListViewModel;
    ...
    private void setListeners() {
        ...
        mBinding.filterTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putSerializable(BottomSheetFilterDialogFragment.ARGS_FILTERED_OPTIONS, mViewModel.getOptions());
                bundle.putSerializable(BottomSheetFilterDialogFragment.ARGS_CALLBACK, mFilterCallbackInstance);
